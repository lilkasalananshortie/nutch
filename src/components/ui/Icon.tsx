...
export type IconName = "music" | "notes" | "planner" | "search" | "focus" | "timer" | "notifications" | "settings" | "battery" | "bolt" | "back" | "plus" | "volume";
...
const paths: Record<IconName, ReactNode> = {
  ...
  timer: <><circle cx="12" cy="13" r="7" fill="none" stroke="currentColor" strokeWidth="1.6" /><path d="M9 3h6M12 6v7l3 2" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" /></>,
