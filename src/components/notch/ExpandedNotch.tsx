...
export function ExpandedNotch({ format, battery, media, mediaError, unreadCount, onSettings, onNotes, onNotifications, onPlanner, onSearch, onFocus, onTimer, onCapture, onToday, onVolumeActivity, onMediaControl }: ExpandedNotchProps) {
